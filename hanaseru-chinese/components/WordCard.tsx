...
export default function WordCard({
  ...
  const primary = direction === "zh-ja" ? word.word : word.meaning;
  const secondary = direction === "zh-ja" ? word.meaning : word.word;
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.primaryText, { color: colors.text }, direction === "zh-ja" ? targetFont : null]}>
        {primary}
      </Text>
      {direction === "zh-ja" && word.pronunciation ? (
        <Text style={[styles.pronunciation, { color: colors.textSecondary }]}>
          [{word.pronunciation}]
        </Text>
      ) : null}
      <Text style={[styles.secondaryText, { color: colors.textSecondary }, direction === "ja-zh" ? targetFont : null]}>
        {secondary}
      </Text>
        ...
        >
          {word.example_native ? (
            <View style={styles.exampleBlock}>
              ...
              <Text style={[styles.exampleText, { color: colors.text }, targetFont]}>
                {word.example_native}
              </Text>
              <Text
                style={[
